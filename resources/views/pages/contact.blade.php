<x-layout>
    <x-slot:title>Contact Us - Manhitha Gift Shop</x-slot:title>
    
    <div class="container mx-auto py-8 px-4">
        <!-- Page Header -->
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-6xl font-bold text-pink-600 dark:text-pink-400 mb-4">Contact Us</h1>
            <p class="text-xl text-pink-500 dark:text-pink-300 max-w-3xl mx-auto">
                Get in touch with us for any questions, orders, or support. We're here to help you find the perfect gift!
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-8">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                    <h2 class="text-2xl font-bold text-pink-600 dark:text-pink-400 mb-6">Get In Touch</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-pink-600 dark:text-pink-400">Email</h3>
                                <p class="text-pink-500 dark:text-pink-300">info@manhitha.com</p>
                                <p class="text-sm text-pink-400 dark:text-pink-200">We'll respond within 24 hours</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-pink-600 dark:text-pink-400">Business Hours</h3>
                                <div class="text-pink-500 dark:text-pink-300 space-y-1">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                <form class="space-y-6">
                    ...
                    <button type="submit" 
                            class="w-full bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
                        Send Message
                    </button>
                </form>
            </div>
        ...
        <div class="mt-16">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                <h2 class="text-2xl font-bold text-pink-600 dark:text-pink-400 text-center mb-6">Frequently Asked Questions</h2>
                
                <div class="space-y-4">
                    <div class="border-b border-pink-200 dark:border-pink-700 pb-4">
                        <h3 class="text-lg font-semibold text-pink-600 dark:text-pink-400 mb-2">How can I place an order?</h3>
                        <p class="text-pink-500 dark:text-pink-300">You can place orders through WhatsApp, phone, or by visiting our store. We also accept orders through our contact form.</p>
                    </div>
                    
                    <div class="border-b border-pink-200 dark:border-pink-700 pb-4">
                        <h3 class="text-lg font-semibold text-pink-600 dark:text-pink-400 mb-2">What are your delivery options?</h3>
                        <p class="text-pink-500 dark:text-pink-300">We offer home delivery, store pickup, and can arrange for courier services. Delivery charges vary based on location.</p>
                    </div>
                    
                    <div class="border-b border-pink-200 dark:border-pink-700 pb-4">
                        <h3 class="text-lg font-semibold text-pink-600 dark:text-pink-400 mb-2">Do you accept returns?</h3>
                        <p class="text-pink-500 dark:text-pink-300">Yes, we accept returns within 7 days of purchase for defective items. Custom orders may have different return policies.</p>
                    </div>
                    
                    <div class="border-b border-pink-200 dark:border-pink-700 pb-4">
                        <h3 class="text-lg font-semibold text-pink-600 dark:text-pink-400 mb-2">Can I customize my order?</h3>
                        <p class="text-pink-500 dark:text-pink-300">Absolutely! We specialize in custom gifts and can personalize most of our products according to your requirements.</p>
                    </div>
                </div>
            </div>
        </div>
